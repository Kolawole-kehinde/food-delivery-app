...
const CartItem = ({ image, name, seller, price, quantity, onRemove, onIncrease, onDecrease }) => {
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <div className="flex items-center mt-3 gap-2">
              ...
              <div className="flex items-center border rounded">
                <button onClick={onDecrease} className="px-4 py-2 border-r">-</button>
                <span className="px-4">{quantity}</span>
                <button onClick={onIncrease} className="px-4 py-2 border-l">+</button>
              </div>
            </div>
          </div>
        </div>
